...
//	echo "<link rel='stylesheet' href='http://localhost/~wassmer/jquery/jquery.mobile-1.0a1.min.css'/>" . chr(10);
//  echo "<script type='text/javascript' src='http://localhost/~wassmer/jquery/jquery-1.6.1.js'></script>" . chr(10);
//	echo "<script type='text/javascript' src='http://localhost/~wassmer/jquery/jquery.mobile.1.0a4.1.js'></script>" . chr(10);
?>